...
d_conc_subset <- PKNCAconc(
  Theoph |> filter(Subject %in% c("1", "2", "3")),
  conc ~ Time | Subject
)
o_data_subj <- PKNCAdata(d_conc_subset, intervals = subject_intervals)
...
o_urine <- pk.nca(PKNCAdata(d_urine_conc, d_urine_dose, intervals = urine_intervals))
