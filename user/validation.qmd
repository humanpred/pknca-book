...
## PKNCA's validation approach

The validation strategy is **reproducibility-first**: re-running the test suite in your local environment and obtaining the same results as the original package development constitutes confirmation that the software is working correctly in your system. This mirrors the package's own [PKNCA Validation](https://humanpred.github.io/pknca/articles/v60-PKNCA-validation.html) vignette.
...
If this returns an empty string, the tests were not installed. Standard CRAN installs do not include tests by default; see “Installing with tests and running the suite” below for how to install them.

---

## Installing with tests and running the suite
...
- **WARN w** — warnings during tests are expected; the [PKNCA validation vignette](https://humanpred.github.io/pknca/articles/v60-PKNCA-validation.html) explicitly notes that warnings appear during testing and are not displayed in the published vignette.
...
## Spot-checking a calculation against a known reference
...
## Reproducibility reporting with `sessionInfo()`
...
**pkgdown reference:** [PKNCAconc()](https://humanpred.github.io/pknca/reference/PKNCAconc.html) · [PKNCAdose()](https://humanpred.github.io/pknca/reference/PKNCAdose.html) · [PKNCAdata()](https://humanpred.github.io/pknca/reference/PKNCAdata.html) · [pk.nca()](https://humanpred.github.io/pknca/reference/pk.nca.html) · [as.data.frame()](https://humanpred.github.io/pknca/reference/as.data.frame.PKNCAresults.html) · [PKNCA.options()](https://humanpred.github.io/pknca/reference/PKNCA.options.html)
:::
