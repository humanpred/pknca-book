...
If this returns an empty string, the tests were not installed. Standard CRAN installs do not include tests by default; see “Installing with tests and running the suite” above for how to install them.
