...
The exclusion reason travels with the data (shown above), and the excluded point is dropped from every parameter calculation — the λz exclusion example above shows the resulting change in `lambda.z.n.points`.
