...
The λz point-selection algorithm and its quality criteria are detailed in the [Half-life chapter](halflife.qmd) and the [Half-Life Calculation vignette](https://humanpred.github.io/pknca/articles/v06-half-life-calculation.html).
...
Assign units to get automatic unit propagation through derived parameters. See the [Units chapter](units.qmd) and [Unit Assignment and Conversion with PKNCA](https://humanpred.github.io/pknca/articles/v07-unit-conversion.html) for the full units workflow.
...
Summary customization and results exclusion are covered in the [Post-processing chapter](postprocessing.qmd) and the [Post-Processing vignette](https://humanpred.github.io/pknca/articles/v07-post-processing.html).
