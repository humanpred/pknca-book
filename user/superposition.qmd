...
The core assumption is **linear, time-invariant pharmacokinetics**: the drug does not accumulate non-linearly, and clearance and volume do not change over time. See also the package vignette [Superposition of Pharmacokinetic Data](https://humanpred.github.io/pknca/articles/v20-superposition.html).
...
Interpolation and tail extrapolation use the dose-*unaware* `interp.extrap.conc()`, governed by the `method` argument (default: `PKNCA.options("auc.method")`) and by `auc.type` — see the [AUC integration methods vignette](https://humanpred.github.io/pknca/articles/v23-auc-integration-methods.html).
...
**pkgdown reference:** [PKNCAconc()](https://humanpred.github.io/pknca/reference/PKNCAconc.html) · [superposition()](https://humanpred.github.io/pknca/reference/superposition.html) · [interp.extrap.conc()](https://humanpred.github.io/pknca/reference/interp.extrap.conc.html)
:::
