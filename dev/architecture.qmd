...
For the full walkthrough — parameters computed from raw concentration-time data, multi-output functions, and custom summary statistics — see the [Writing Custom Parameters chapter](../user/custom-parameters.qmd).
...
> This overview covers the surface. The business rules (`002-pk.business.rules.R`) and the validation framework (`v60-PKNCA-validation.Rmd`) in the PKNCA sources are richer topics worth exploring further.
