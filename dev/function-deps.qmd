...
# take their colour from the group definition, so they always match
for (grp in names(category_colours)) {
  graph <- visGroups(graph, groupname = grp, color = category_colours[[grp]])
}
graph
```
